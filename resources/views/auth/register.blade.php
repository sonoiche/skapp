            ...
            <div class="block-center mt-4 wd-xl">
                ...
                <div class="card card-flat">
                    ...
                    <div class="card-body">
                        ...
                        <form class="mb-3 needs-validation" id="loginForm" action="{{ route('register') }}" method="POST" novalidate>
                            @csrf
                            <div class="form-group">
                                <div class="input-group with-focus">
                                    <input class="form-control border-right-0" id="fname" name="fname" type="text" placeholder="Enter first name" autocomplete="off" required />
                            ...
                            <div class="form-group">
                                <div class="input-group with-focus">
                                    <input class="form-control border-right-0" id="lname" name="lname" type="text" placeholder="Enter last name" autocomplete="off" required />
                                    <div class="input-group-append">
                                        <span class="input-group-text text-muted bg-transparent border-left-0"><em class="fa fa-user"></em></span>
                                    </div>
                                </div>
