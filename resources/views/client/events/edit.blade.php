@extends('layouts.app', ['page' => ['name' => 'Update Event Information']])
@section('content')
<div class="row">
    <div class="col-md-6 col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ url('client/events', $event->id) }}" method="post" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
...
$(document).ready(function () {
    ...
    .then( editor => {
        ...
        editor.setData('<?php echo $event->description; ?>');
    })
    .catch( err => {
    ...
    .then( editor => {
        window.editor = editor;
        editor.ui.view.editable.element.style.height = '200px';
        editor.setData('<?php echo $event->event_goal; ?>');
    })
    .catch( err => {
        console.error( err.stack );
    });
